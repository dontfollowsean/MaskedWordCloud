...
image_file = Image.open('images/alexis.jpeg')
image_file = image_file.convert("L") # convert image to black and white
image_file.mode = "L"
image_file = image_file.point(lambda x: 0 if x>128 else 255)
print("Saving BW Image")
image_file.save('images/output/grayscale.jpg')

#find edges
print("Creating Outline of BW Image")
edges = filter.canny(imread(path.join(d,'images/output/grayscale.jpg')), sigma=3)
edimage = toimage(edges)


# read the mask image
print("Reading BW Image")
mask = imread(path.join(d, "images/output/grayscale.jpg"))
